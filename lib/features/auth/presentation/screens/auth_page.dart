...
import 'package:homebased_project/features/auth/domain/auth_service_redux.dart';
...
class _AuthPageState extends State<AuthPage> {
  final AuthServiceRedux _authService = AuthServiceRedux();
  ...
  Future<void> signUp() async {
    ...
    try {
      ...
      // Redux listener will handle navigation and login state
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppAuthState>(
      ...
      builder: (context, authState) {
        ...
        if (isAuthenticated) {
          return const WidgetTree(); // AuthGate will also handle this
        }
